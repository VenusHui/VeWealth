...
class AddWatchListRequest(BaseModel):
    ...
    alert_threshold: Optional[float] = Field(None, ge=0, le=1, description="个性化预警阈值（null则使用用户默认值）")
...
class UpdateWatchListRequest(BaseModel):
    ...
    alert_threshold: Optional[float] = Field(None, ge=0, le=1, description="个性化预警阈值")
